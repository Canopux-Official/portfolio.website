      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="inline-flex items-center px-4 py-1.5 rounded-full border border-border bg-secondary/50 mb-8 opacity-0 animate-fade-in">
            <span className="text-sm text-muted-foreground">A Builder Collective</span>
          </div>

          {/* Headline */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight mb-6 opacity-0 animate-fade-in animation-delay-200">
